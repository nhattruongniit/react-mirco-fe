import { r as reactExports, g as getAugmentedNamespace } from './__federation_shared_react-7a25260f.js';
import { importShared } from './__federation_fn_import-bc878a87.js';
...
const TransitionGroupContext = React$o.createContext(null);
...
var TransitionGroup = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    if (Component === null) {
      return /*#__PURE__*/React$n.createElement(TransitionGroupContext.Provider, {
        value: contextValue
      }, children);
    }
    ...
    return /*#__PURE__*/React$n.createElement(TransitionGroupContext.Provider, {
      value: contextValue
    }, /*#__PURE__*/React$n.createElement(Component, props, children));
  };
...
var useInsertionEffect = React$l['useInsertion' + 'Effect'] ? React$l['useInsertion' + 'Effect'] : false;
var useInsertionEffectAlwaysWithSyncFallback = useInsertionEffect || syncFallback;
var useInsertionEffectWithLayoutFallback = useInsertionEffect || React$l.useLayoutEffect;

const React$k = await importShared('react');

const {useContext,forwardRef} = await importShared('react');

var EmotionCacheContext = /* #__PURE__ */React$k.createContext( // we're doing this to avoid preconstruct's dead code elimination in this one case
...
var ThemeContext = /* #__PURE__ */React$k.createContext({});
...
var Global = /* #__PURE__ */withEmotionCache(function (props, cache) {
  ...
  var serialized = serializeStyles([styles], undefined, React$j.useContext(ThemeContext));
  // but it is based on a constant that will never change at runtime
  // it's effectively like having two implementations and switching them out
  // so it's not actually breaking anything


  var sheetRef = React$j.useRef();
  ...
  return function () {
    ...
    var Styled = withEmotionCache(function (props, cache, ref) {
      ...
      if (props.theme == null) {
        ...
        mergedProps.theme = React$i.useContext(ThemeContext);
      }
      ...
      newProps.ref = ref;
      return /*#__PURE__*/React$i.createElement(React$i.Fragment, null, /*#__PURE__*/React$i.createElement(Insertion, {
        cache: cache,
        serialized: serialized,
        isStringTag: typeof FinalTag === 'string'
      }), /*#__PURE__*/React$i.createElement(FinalTag, newProps));
    });
...
function useTheme$1(defaultTheme = null) {
  const contextTheme = React$h.useContext(ThemeContext);
 ...
 */
const useEnhancedEffect = typeof window !== 'undefined' ? React$g.useLayoutEffect : React$g.useEffect;
...
function useEventCallback(fn) {
  const ref = React$f.useRef(fn);
  useEnhancedEffect$1(() => {
    ref.current = fn;
  });
  return React$f.useRef((...args) =>
...
function useLazyRef(init, initArg) {
  const ref = React$e.useRef(UNINITIALIZED);
...
function useIsFocusVisible() {
  const ref = React$c.useCallback(node => {
    if (node != null) {
      prepare(node.ownerDocument);
    }
  }, []);
  const isFocusVisibleRef = React$c.useRef(false);
...
const _excluded$8 = ["className", "component", "elevation", "square", "variant"];
...
const Paper = /*#__PURE__*/React$b.forwardRef(function Paper(inProps, ref) {
 ...
 */
const TouchRipple = /*#__PURE__*/React$9.forwardRef(function TouchRipple(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: 'MuiTouchRipple'
  });
 ...
 */
const ButtonBase = /*#__PURE__*/React$8.forwardRef(function ButtonBase(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: 'MuiButtonBase'
  });
  ...
  const rippleRef = React$8.useRef(null);
   ...
   */
  const keydownRef = React$8.useRef(false);
...
const Typography = /*#__PURE__*/React$7.forwardRef(function Typography(inProps, ref) {
 ...
 * @ignore - internal component.
 */
const ButtonGroupButtonContext = /*#__PURE__*/React$5.createContext(undefined);
...
const Button = /*#__PURE__*/React$4.forwardRef(function Button(inProps, ref) {
  // props priority: `inProps` > `contextProps` > `themeDefaultProps`
  const contextProps = React$4.useContext(ButtonGroupContext$1);
  const buttonGroupButtonContextPositionClassName = React$4.useContext(ButtonGroupButtonContext$1);
...
const CardRoot = styled$1(Paper2, {
  name: 'MuiCard',
  slot: 'Root',
  overridesResolver: (props, styles) => styles.root
})(() => {
...
const Card = /*#__PURE__*/React$3.forwardRef(function Card(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: 'MuiCard'
  });
...
const CardContent = /*#__PURE__*/React$2.forwardRef(function CardContent(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: 'MuiCardContent'
  });
...
const CardActions = /*#__PURE__*/React$1.forwardRef(function CardActions(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: 'MuiCardActions'
  });
...
function Product() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card$1, { sx: { maxWidth: 345 }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent$1, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Typography$1, { gutterBottom: true, variant: "h5", component: "div", children: "Lizard" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Typography$1, { variant: "body2", color: "text.secondary", children: "Lizards are a widespread group of squamate reptiles, with over 6,000 species, ranging across all continents except Antarctica" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardActions$1, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { size: "small", children: "Share" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { size: "small", children: "Learn More" })
    ] })
  ] });
}

export { generateUtilityClasses as A, styled$1 as B, capitalize$1 as C, useThemeProps as D, useForkRef as E, duration as F, GlobalStyles as G, useTimeout as H, useEventCallback as I, createTheme as J, ClassNameGenerator$1 as K, useEnhancedEffect$1 as L, setRef as M, globalStateClasses as N, require$$1 as O, alpha_1 as P, Product, useIsFocusVisible as Q, Timeout as R, ButtonBase$1 as S, TransitionGroupContext as T, keyframes as U, css as V, Typography$1 as W, Button$1 as X, _inheritsLoose as _, _objectWithoutPropertiesLoose as a, styleFunctionSx$2 as b, _extends$1 as c, clsx as d, extendSxProp as e, createTheme$2 as f, isPlainObject as g, formatMuiErrorMessage$1 as h, internal_processStyles as i, jsxRuntimeExports as j, clamp$1 as k, useTheme$1 as l, ThemeContext as m, useThemeProps$1 as n, handleBreakpoints as o, createUnarySpacing as p, deepmerge$1 as q, resolveBreakpointValues as r, styled$2 as s, mergeBreakpointsInOrder as t, useTheme as u, getValue as v, composeClasses as w, generateUtilityClass as x, defaultTheme$1 as y, THEME_ID as z };
